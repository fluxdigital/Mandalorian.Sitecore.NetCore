...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.myproject.localhost"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.myproject.localhost"

    # RENDERING_HOST
    Set-DockerComposeEnvFileVariable "RENDERING_HOST" -Value "www.myproject.localhost"
